...
/*#include <X11/Xaw_d/DrawingAP.h>*/  /* dfs */
#include "DrawingAP.h"
...
static void Initialize(DrawingAreaWidget request, DrawingAreaWidget new)
{
...
/* ARGSUSED */
static void
resize_draw(DrawingAreaWidget w, XEvent *event, char *args[], int n_args)
{
  XawDrawingAreaCallbackStruct cb;
...
/* ARGSUSED */
static void
input_draw(DrawingAreaWidget w, XEvent *event, char *args[], int n_args)
{
  XawDrawingAreaCallbackStruct cb;
...
/* ARGSUSED */
static void
motion_draw(DrawingAreaWidget w, XEvent *event, char *args[], int n_args)
{
  XawDrawingAreaCallbackStruct cb;
